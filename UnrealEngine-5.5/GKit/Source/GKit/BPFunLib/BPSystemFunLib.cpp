...
void UBPSystemFunLib::GetCPUInfo(FString& UID, FString& Brand, FString& Vebdor)
{
...
void UBPSystemFunLib::GetGPUInfo(FString& VendorId, FString& DeviceDescription, FString& ProviderName, FString& InternalDriverVersion, FString& UserDriverVersion, FString& DriverDate, FString& RHIName)
{
...
void UBPSystemFunLib::GetGPUMemoeyInfoByRHI(float& DedicatedVideoMemory, float& DedicatedSystemMemory, float& SharedSystemMemory)
{
...
void UBPSystemFunLib::GetCurrenSystemScreenResolution(int& Length, int& Width)
{
    Length = GetSystemMetrics(SM_CXSCREEN);
    Width = GetSystemMetrics(SM_CYSCREEN);
}

void UBPSystemFunLib::GetAllSupportedResolutions(TArray<FIntPoint>& Resolutions)
{
...
void UBPSystemFunLib::GetResolutionSpecified(const TArray<FIntPoint>& InResolutions, TArray<FIntPoint>& OutResolutions, const float Length, const float Width, const float Accuracy)
{
...
FString UBPSystemFunLib::GetMacAddressString()
{
    return FPlatformMisc::GetMacAddressString();
}

EAAMethod UBPSystemFunLib::GetAAMethod()
{
...
void UBPSystemFunLib::SetRHI(ERHI RHI)
{
    FString ConfigPath;
#if WITH_EDITOR
...
EUEWorldType UBPSystemFunLib::GetWorldType()
{
